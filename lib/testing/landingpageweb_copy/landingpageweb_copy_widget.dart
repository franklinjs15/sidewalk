...
import 'landingpageweb_copy_model.dart';
export 'landingpageweb_copy_model.dart';

class LandingpagewebCopyWidget extends StatefulWidget {
  const LandingpagewebCopyWidget({super.key});

  @override
  State<LandingpagewebCopyWidget> createState() =>
      _LandingpagewebCopyWidgetState();
}

class _LandingpagewebCopyWidgetState extends State<LandingpagewebCopyWidget> {
  late LandingpagewebCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LandingpagewebCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'landingpagewebCopy'});
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 1.0),
                            child: Text(
                              'Local business owners across the country sharing real-time trends',
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'LANDINGPAGEWEB_COPY_Image_769kv03k_ON_TA');
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'LANDINGPAGEWEB_COPY_Image_wminj6bw_ON_TA');
                                  logFirebaseEvent('Image_haptic_feedback');
                                  HapticFeedback.lightImpact();
                                  logFirebaseEvent('Image_launch_u_r_l');
                                  await launchURL(
