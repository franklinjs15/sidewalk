...
import 'backup_categories_page_model.dart';
export 'backup_categories_page_model.dart';

class BackupCategoriesPageWidget extends StatefulWidget {
  const BackupCategoriesPageWidget({super.key});

  @override
  State<BackupCategoriesPageWidget> createState() =>
      _BackupCategoriesPageWidgetState();
}

class _BackupCategoriesPageWidgetState extends State<BackupCategoriesPageWidget>
    with TickerProviderStateMixin {
  late BackupCategoriesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BackupCategoriesPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'backup_categories_page'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('BACKUP_CATEGORIES_backup_categories_page');
      logFirebaseEvent('backup_categories_page_google_analytics_');
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<VideosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VideosRecord> backupCategoriesPageVideosRecordList =
            snapshot.data!;
                      ...
                      children: [
                                      ...
                                      child: CarouselSlider.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'BACKUP_CATEGORIES_Image_7o1dvsp1_ON_TAP');
                                              logFirebaseEvent(
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final revenue =
                                  backupCategoriesPageVideosRecordList
                                      .where((e) =>
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'BACKUP_CATEGORIES_Image_3pype6eu_ON_TAP');
                                                logFirebaseEvent(
                                                    'Image_navigate_to');
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'BACKUP_CATEGORIES_Icon_g55ndagn_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_navigate_to');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'BACKUP_CATEGORIES_Text_lbn4ugwe_ON_TAP');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'BACKUP_CATEGORIES_Icon_sw5kjn36_ON_TAP');
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'BACKUP_CATEGORIES_SUBMIT_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_backend_call');
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final rent = backupCategoriesPageVideosRecordList
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'BACKUP_CATEGORIES_Image_k7gue4v4_ON_TAP');
                                                logFirebaseEvent(
                                                    'Image_navigate_to');
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'BACKUP_CATEGORIES_Icon_2j5pzjq5_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_navigate_to');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'BACKUP_CATEGORIES_Text_ntbe6pjv_ON_TAP');
                                          logFirebaseEvent('Text_navigate_to');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'BACKUP_CATEGORIES_Icon_k3bt5r90_ON_TAP');
                                          logFirebaseEvent('Icon_navigate_to');
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'BACKUP_CATEGORIES_Image_ogs2rsbs_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Image_navigate_to');
                                            ...
                                            Align(
                                              ...
                                              child: Container(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'BACKUP_CATEGORIES_Icon_3tr88tpy_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Icon_navigate_to');
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'BACKUP_CATEGORIES_Image_7pkkhxap_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Image_navigate_to');
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'BACKUP_CATEGORIES_Icon_zxljb2bd_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Icon_navigate_to');
                                                      ...
                                                      context.pushNamed(
                                                        ...
                                                        extra: <String,
                                                            dynamic>{
                                                          'videos': backupCategoriesPageVideosRecordList
                                                              .where((e) => e
                                                                  .categories
                                                                  .contains(
                                                                      'Payscales'))
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'BACKUP_CATEGORIES_Text_wfladj49_ON_TAP');
                                          logFirebaseEvent('Text_navigate_to');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'BACKUP_CATEGORIES_Icon_rst3vt5v_ON_TAP');
                                          logFirebaseEvent('Icon_navigate_to');
                                              ...
                                              children: [
                                                Align(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'BACKUP_CATEGORIES_Image_2lojxhxr_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Image_navigate_to');
                                                ...
                                                Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'BACKUP_CATEGORIES_Icon_x7slconj_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Icon_navigate_to');
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'BACKUP_CATEGORIES_Image_eqdwe83i_ON_TAP');
                                                logFirebaseEvent(
                                                    'Image_navigate_to');
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'BACKUP_CATEGORIES_Icon_b2jdh0oa_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_navigate_to');
